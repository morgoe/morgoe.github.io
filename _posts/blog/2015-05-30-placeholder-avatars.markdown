...
<div class="m-top--sm">
	{% include image.html style="full" url="/assets/images/blog/placeholder-avatars/before-after.png" description="With and without user-uploaded display photos. <a href='https://dribbble.com/shots/1818748-Appon-Chat-Widget'>Original by Olia Gozha</a>." %}
</div>
...
<div class="m-top--sm">
	{% include image.html style="full" url="/assets/images/blog/placeholder-avatars/silhouettes.png" description="Facebook's placeholder avatars." %}
</div>
...
<div class="m-top--sm">
	{% include image.html style="full" url="/assets/images/blog/placeholder-avatars/apple.jpg" width="320" description="iOS's placeholder avatars." %}
</div>
...
<div class="m-top--sm">
	{% include image.html style="full" url="/assets/images/blog/placeholder-avatars/dropbox.png" width="320" description="Dropbox's placeholder avatars." %}
</div>
...
Next, learn how to [encourage users to upload an avatar](/design-solutions/encouraging-users/).
